...
from settings import ALLOWED_EXTENSIONS, UPLOAD_DIR, INITIAL_DIR
...
def compare_data(initial_df, new_df):
    ...
    # normalize key column name to a common name
    ...
    for k in all_keys:
        ...
        # ensure both are Series (handle duplicates by taking first)
...
def find_latest_upload():
    """Return the most recently modified file path in the upload directory, or None."""
    candidates = []
